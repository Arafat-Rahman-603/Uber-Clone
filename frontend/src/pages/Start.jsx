  ...
  return (
   <div className="flex bg-[url(/home-bg-img.png)] bg-cover bg-center flex-col justify-between bg-black h-screen w-full">
    ...
    <div className='bg-white w-full p-4'>
        ...
        <Link
        to='/user/login'
         className='bg-black px-4 flex justify-between items-center text-white w-full h-12 rounded-md mt-4 mx-auto mt-7 font-semibold active:scale-95 transition-all duration-300 cursor-pointer'
         >
          <p className=""></p>
